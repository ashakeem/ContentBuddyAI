    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800">
      ...
      <div className="fixed inset-y-0 left-0 z-50">
        <div className={`
          ...
          w-64 min-h-screen bg-gray-800/95 backdrop-blur-sm border-r border-gray-700
        `}>
          <div className="p-6">
            ...
            <nav className="space-y-2">
              ...
              <button
                onClick={logout}
                className="w-full px-4 py-2 rounded-lg text-left text-red-400 hover:bg-red-500/10 transition-colors"
              >
                Logout
              </button>
            </nav>
      ...
      <button
        ...
        className="md:hidden fixed bottom-4 left-4 p-3 bg-blue-500 text-white rounded-full shadow-lg"
      >
        <svg
          className="w-6 h-6"
          fill="none"
